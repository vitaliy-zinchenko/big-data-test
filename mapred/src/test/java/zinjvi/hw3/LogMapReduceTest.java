...
public class LogMapReduceTest {
    ...
    MapReduceDriver<LongWritable, Text, Text, LogMapResultWritable, Text, LogResultWritable> mapReduceDriver;
    ...
    public void testMap() throws Exception {
        ...
        //when
        List<Pair<Text, LogResultWritable>> result = mapReduceDriver.run();
